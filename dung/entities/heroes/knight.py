...
class Knight(Hero):
    ...
    def use_ability_q(self, skill_item, enemy: Entity, ):
        ...
        super().set_buff("shield", shield_bonus, duration)
        super().set_cooldown(pygame.K_q, cooldown)
    ...
    def use_ability_w(self, skill_item, enemy: Entity):
        ...
        super().set_cooldown(pygame.K_w, cooldown)
    ...
    def use_ability_e(self, skill_item, enemy: Entity):
        ...
        super().set_cooldown(pygame.K_e, cooldown)
